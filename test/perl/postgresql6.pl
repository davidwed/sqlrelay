...
# usage...
if ($#ARGV+1<5) {
	print("usage: postgresql.pl host port socket user password");
	exit;
}
...
checkSuccessString($cur->getColumnType(2),"float8");
checkSuccessString($cur->getColumnType('testreal'),"float8");
...
checkSuccessString($cur->getField(0,6),"01-01-2001");
...
checkSuccessString($cur->getField(7,6),"01-01-2008");
...
checkSuccessString($cur->getField(0,"testdate"),"01-01-2001");
...
checkSuccessString($cur->getField(7,"testdate"),"01-01-2008");
...
checkSuccessString($fields{"testdate"},"01-01-2001");
...
checkSuccessString($fields{"testdate"},"01-01-2008");
...
$secondcon=Firstworks::SQLRConnection->new($ARGV[0],$ARGV[1], 
		$ARGV[2],$ARGV[3],$ARGV[4],0,1);

...
print("COLUMN NAMES: \n");
checkSuccessString($cur->getColumnName(0),"TESTINTEGER");
checkSuccessString($cur->getColumnName(1),"TESTSMALLINT");
checkSuccessString($cur->getColumnName(2),"TESTDECIMAL");
checkSuccessString($cur->getColumnName(3),"TESTNUMERIC");
...
checkSuccessString($cur->getColumnName(8),"TESTCHAR");
checkSuccessString($cur->getColumnName(9),"TESTVARCHAR");
...
print("COLUMN TYPES: \n");
checkSuccessString($cur->getColumnType(0),"INTEGER");
checkSuccessString($cur->getColumnType('TESTINTEGER'),"INTEGER");
checkSuccessString($cur->getColumnType(1),"SMALLINT");
checkSuccessString($cur->getColumnType('TESTSMALLINT'),"SMALLINT");
checkSuccessString($cur->getColumnType(2),"DECIMAL");
checkSuccessString($cur->getColumnType('TESTDECIMAL'),"DECIMAL");
checkSuccessString($cur->getColumnType(3),"NUMERIC");
...
checkSuccessString($cur->getColumnType(5),"DOUBLE PRECISION");
checkSuccessString($cur->getColumnType('TESTDOUBLE'),"DOUBLE PRECISION");
...
checkSuccessString($cur->getColumnType(8),"CHAR");
checkSuccessString($cur->getColumnType('TESTCHAR'),"CHAR");
checkSuccessString($cur->getColumnType(9),"VARCHAR");
...
checkSuccessString($cur->getField(0,2),"1.10");
checkSuccessString($cur->getField(0,3),"1.10");
checkSuccessString($cur->getField(0,4),"1.1000");
checkSuccessString($cur->getField(0,5),"1.1000");
checkSuccessString($cur->getField(0,6),"2001:01:01");
checkSuccessString($cur->getField(0,7),"01:00:00");
checkSuccessString($cur->getField(0,8),"testchar1                                         ");
checkSuccessString($cur->getField(0,9),"testvarchar1");
print("\n");
checkSuccessString($cur->getField(7,0),"8");
checkSuccessString($cur->getField(7,1),"8");
checkSuccessString($cur->getField(7,2),"8.80");
checkSuccessString($cur->getField(7,3),"8.80");
checkSuccessString($cur->getField(7,4),"8.8000");
checkSuccessString($cur->getField(7,5),"8.8000");
checkSuccessString($cur->getField(7,6),"2008:01:01");
checkSuccessString($cur->getField(7,7),"08:00:00");
checkSuccessString($cur->getField(7,8),"testchar8                                         ");
checkSuccessString($cur->getField(7,9),"testvarchar8");
print("\n");
...
checkSuccessString($cur->getField(0,"TESTINTEGER"),"1");
checkSuccessString($cur->getField(0,"TESTSMALLINT"),"1");
checkSuccessString($cur->getField(0,"TESTDECIMAL"),"1.10");
checkSuccessString($cur->getField(0,"TESTNUMERIC"),"1.10");
checkSuccessString($cur->getField(0,"TESTFLOAT"),"1.1000");
checkSuccessString($cur->getField(0,"TESTDOUBLE"),"1.1000");
...
print("\n");
checkSuccessString($cur->getField(7,"TESTINTEGER"),"8");
checkSuccessString($cur->getField(7,"TESTSMALLINT"),"8");
checkSuccessString($cur->getField(7,"TESTDECIMAL"),"8.80");
checkSuccessString($cur->getField(7,"TESTNUMERIC"),"8.80");
checkSuccessString($cur->getField(7,"TESTFLOAT"),"8.8000");
checkSuccessString($cur->getField(7,"TESTDOUBLE"),"8.8000");

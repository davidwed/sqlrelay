...
# usage...
if ($#ARGV+1<5) {
	print("usage: freetds.pl host port socket user password");
	exit;
}
...
$cur->inputBind("var10","01-Jan-2008  8:00:00");
$cur->inputBind("var11","01-Jan-2008  8:00:00");
...
checkSuccessString($cur->getColumnType('testdecimal'),"FLOAT");
checkSuccessString($cur->getColumnType(6),"FLOAT");
checkSuccessString($cur->getColumnType('testnumeric'),"FLOAT");
...
checkSuccess($cur->getLongest(7),6);
checkSuccess($cur->getLongest('testmoney'),6);
...
checkSuccessString($cur->getField(0,7),"1.0000");
checkSuccessString($cur->getField(0,8),"1.00");
checkSuccessString($cur->getField(0,9),"Jan  1 2001  1:00AM");
checkSuccessString($cur->getField(0,10),"Jan  1 2001  1:00AM");
...
checkSuccessString($cur->getField(7,7),"8.0000");
checkSuccessString($cur->getField(7,8),"8.00");
checkSuccessString($cur->getField(7,9),"Jan  1 2008  8:00AM");
checkSuccessString($cur->getField(7,10),"Jan  1 2008  8:00AM");
...
checkSuccess($cur->getFieldLength(0,7),6);
...
checkSuccess($cur->getFieldLength(7,7),6);
...
checkSuccessString($cur->getField(0,"testmoney"),"1.0000");
checkSuccessString($cur->getField(0,"testsmallmoney"),"1.00");
checkSuccessString($cur->getField(0,"testdatetime"),"Jan  1 2001  1:00AM");
checkSuccessString($cur->getField(0,"testsmalldatetime"),"Jan  1 2001  1:00AM");
...
checkSuccessString($cur->getField(7,"testmoney"),"8.0000");
checkSuccessString($cur->getField(7,"testsmallmoney"),"8.00");
checkSuccessString($cur->getField(7,"testdatetime"),"Jan  1 2008  8:00AM");
checkSuccessString($cur->getField(7,"testsmalldatetime"),"Jan  1 2008  8:00AM");
...
checkSuccess($cur->getFieldLength(0,"testmoney"),6);
...
checkSuccess($cur->getFieldLength(7,"testmoney"),6);
...
checkSuccessString($fields{"testdatetime"},"Jan  1 2001  1:00AM");
checkSuccessString($fields{"testsmalldatetime"},"Jan  1 2001  1:00AM");
...
checkSuccessString($fields{"testdatetime"},"Jan  1 2008  8:00AM");
checkSuccessString($fields{"testsmalldatetime"},"Jan  1 2008  8:00AM");
...
checkSuccess($fieldlengths{"testmoney"},6);

...
namespace SQLRClientTest
{
    class SQLRAdapterTest
    {
        ...
        public static void Main(String[] args)
        {
            ...
            SQLRelayConnection sqlrcon2 = new SQLRelayConnection("Data Source=sqlrelay:9000:/tmp/test.socket;User ID=testuser;Password=testpassword;Retry Time=0;Tries=1;Debug=false");
            sqlrcon2.Open();

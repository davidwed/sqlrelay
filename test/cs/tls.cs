...
namespace SQLRClientTest
{
    class SQLRAdapterTest
    {
        ...
        public static void Main(String[] args)
        {
            ...
            SQLRelayConnection sqlrcon = new SQLRelayConnection("Data Source=localhost:9000;Retry Time=0;Tries=1;Tls=yes;Tlscert=" + tlscert + ";Tlsvalidate=ca;Tlsca=" + tlsca + ";Debug=false");
            sqlrcon.Open();
            ...
            SQLRelayConnection sqlrcon2 = new SQLRelayConnection("Data Source=localhost:9000;Retry Time=0;Tries=1;Tls=yes;Tlscert=" + tlscert + ";Tlsvalidate=ca;Tlsca=" + tlsca + ";Debug=false");
            sqlrcon2.Open();

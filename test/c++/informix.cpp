...
int	main(int argc, char **argv) {
	...
	const char	*bindvals[12]={"4","4","4","4.4","4.4","4.4",
			"testchar4","testvarchar4","01/01/2004","04:00:00","testtext1",NULL};
...
con->debugOn();
	...
	cur->inputBindClob("11","testtext3",9);
	cur->inputBindBlob("12","testbyte3",9);
	checkSuccess(cur->executeQuery(),1);
	stdoutput.printf("\n");
	...
	stdoutput.printf("INSERT: \n");
	checkSuccess(cur->sendQuery("insert into testtable values (5,5,5,5.5,5.5,5.5,'testchar5','testvarchar5','01/01/2005','05:00:00',NULL,'testtext5',byte('testbyte5'))"),1);
	checkSuccess(cur->sendQuery("insert into testtable values (6,6,6,6.6,6.6,6.6,'testchar6','testvarchar6','01/01/2006','06:00:00',NULL,'testtext6',byte('testbyte6'))"),1);
	checkSuccess(cur->sendQuery("insert into testtable values (7,7,7,7.7,7.7,7.7,'testchar7','testvarchar7','01/01/2007','07:00:00',NULL,'testtext7',byte('testbyte7'))"),1);
	checkSuccess(cur->sendQuery("insert into testtable values (8,8,8,8.8,8.8,8.8,'testchar8','testvarchar8','01/01/2008','08:00:00',NULL,'testtext8',byte('testbyte8'))"),1);
	stdoutput.printf("\n");
	...
	checkSuccess(cur->getField(0,"testdatetime"),"01:00:00");
	stdoutput.printf("\n");
	...
	checkSuccess(cur->getField(7,"testdatetime"),"08:00:00");
	stdoutput.printf("\n");
	...
	checkSuccess(cur->getFieldLength(0,"testdatetime"),8);
	stdoutput.printf("\n");
	...
	checkSuccess(cur->getFieldLength(7,"testdatetime"),8);
	stdoutput.printf("\n");

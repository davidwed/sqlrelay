...
int	main(int argc, char **argv) {
	...
	printf("COLUMN TYPES: \n");
	checkSuccess(cur->getColumnType((uint32_t)0),"CHAR");
	...
	checkSuccess(cur->getLongest((uint32_t)0),5);
	...
	checkSuccess(cur->getField(0,(uint32_t)0),"char1");
	...
	printf("\n");
	checkSuccess(cur->getField(7,(uint32_t)0),"char8");
	...
	checkSuccess(cur->getFieldLength(0,(uint32_t)0),5);
	...
	printf("\n");
	checkSuccess(cur->getFieldLength(7,(uint32_t)0),5);
	...
	checkSuccess(cur->getField(0,(uint32_t)0),"char1");
	checkSuccess(cur->getField(1,(uint32_t)0),"char2");
	checkSuccess(cur->getField(2,(uint32_t)0),"char3");
	printf("\n");
	checkSuccess(cur->firstRowIndex(),2);
	checkSuccess(cur->endOfResultSet(),0);
	checkSuccess(cur->rowCount(),4);
	checkSuccess(cur->getField(6,(uint32_t)0),"char7");
	checkSuccess(cur->getField(7,(uint32_t)0),"char8");
	printf("\n");
	...
	checkSuccess(cur->getField(1,(uint32_t)0),"char2");
	checkSuccess(cur->getField(2,(uint32_t)0),"char3");
	checkSuccess(cur->getField(3,(uint32_t)0),"char4");
	checkSuccess(cur->getField(4,(uint32_t)0),"char5");
	checkSuccess(cur->getField(5,(uint32_t)0),"char6");
	checkSuccess(cur->getField(6,(uint32_t)0),"char7");
	checkSuccess(cur->getField(7,(uint32_t)0),"char8");
	printf("\n");
	checkSuccess(cur->sendQuery("select * from testtable order by testint"),1);
	...
	checkSuccess(secondcur->getField(0,(uint32_t)0),"char1");
	...
	checkSuccess(secondcur->sendQuery("select * from testtable order by testint"),1);
	checkSuccess(secondcur->getField(8,(uint32_t)0),"char10");

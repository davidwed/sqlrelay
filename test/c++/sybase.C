...
int	main(int argc, char **argv) {
	...
	checkSuccess(cur->getColumnType(11),"LONGCHAR");
	checkSuccess(cur->getColumnType("testchar"),"LONGCHAR");
	checkSuccess(cur->getColumnType(12),"LONGCHAR");
	checkSuccess(cur->getColumnType("testvarchar"),"LONGCHAR");

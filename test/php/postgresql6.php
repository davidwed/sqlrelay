...
function checkSuccess($value,$success) {
	...
	checkSuccess(sqlrcur_getColumnType($cur,2),"float8");
	checkSuccess(sqlrcur_getColumnType($cur,"testreal"),"float8");
	...
	checkSuccess(sqlrcur_getField($cur,0,6),"01-01-2001");
	...
	checkSuccess(sqlrcur_getField($cur,7,6),"01-01-2008");
	...
	checkSuccess(sqlrcur_getField($cur,0,"testdate"),"01-01-2001");
	...
	checkSuccess(sqlrcur_getField($cur,7,"testdate"),"01-01-2008");

...
function checkSuccess($value,$success) {
	...
	checkSuccess(sqlrcur_sendQuery($cur,"create table testdb.testtable (testtinyint tinyint, testsmallint smallint, testmediumint mediumint, testint int, testbigint bigint, testfloat float, testreal real, testdecimal decimal(1,1), testdate date, testtime time, testdatetime datetime, testyear year, testchar char(40), testtext text, testvarchar varchar(40), testtinytext tinytext, testmediumtext mediumtext, testlongtext longtext, testtimestamp timestamp)"),1);
	echo("\n");
	...
	checkSuccess(sqlrcur_getColumnType($cur,16),"BLOB");
	checkSuccess(sqlrcur_getColumnType($cur,17),"BLOB");
	...
	checkSuccess(sqlrcur_getColumnType($cur,"testmediumtext"),"BLOB");
	checkSuccess(sqlrcur_getColumnType($cur,"testlongtext"),"BLOB");
	checkSuccess(sqlrcur_getColumnType($cur,"testtimestamp"),"TIMESTAMP");
	echo("\n");

	echo("COLUMN LENGTH: \n");
	checkSuccess(sqlrcur_getColumnLength($cur,0),4);
	checkSuccess(sqlrcur_getColumnLength($cur,1),6);
	checkSuccess(sqlrcur_getColumnLength($cur,2),9);
	checkSuccess(sqlrcur_getColumnLength($cur,3),11);
	...
	checkSuccess(sqlrcur_getColumnLength($cur,11),4);
	checkSuccess(sqlrcur_getColumnLength($cur,12),40);
	checkSuccess(sqlrcur_getColumnLength($cur,13),65535);
	checkSuccess(sqlrcur_getColumnLength($cur,14),40);
	checkSuccess(sqlrcur_getColumnLength($cur,15),255);
	checkSuccess(sqlrcur_getColumnLength($cur,16),16777215);
	checkSuccess(sqlrcur_getColumnLength($cur,17),16777215);
	checkSuccess(sqlrcur_getColumnLength($cur,18),14);
	checkSuccess(sqlrcur_getColumnLength($cur,"testtinyint"),4);
	checkSuccess(sqlrcur_getColumnLength($cur,"testsmallint"),6);
	checkSuccess(sqlrcur_getColumnLength($cur,"testmediumint"),9);
	checkSuccess(sqlrcur_getColumnLength($cur,"testint"),11);
	...
	checkSuccess(sqlrcur_getColumnLength($cur,"testyear"),4);
	...
	checkSuccess(sqlrcur_getColumnLength($cur,"testlongtext"),16777215);
	checkSuccess(sqlrcur_getColumnLength($cur,"testtimestamp"),14);
	echo("\n");

...
function checkSuccess($value,$success) {
	...
	checkSuccess(sqlrcur_getLongest($cur,7),6);
	checkSuccess(sqlrcur_getLongest($cur,"testmoney"),6);
	...
	checkSuccess(sqlrcur_getFieldLength($cur,0,7),6);
	...
	checkSuccess(sqlrcur_getFieldLength($cur,7,7),6);
	...
	checkSuccess(sqlrcur_getFieldLength($cur,0,"testmoney"),6);
	...
	checkSuccess(sqlrcur_getFieldLength($cur,7,"testmoney"),6);

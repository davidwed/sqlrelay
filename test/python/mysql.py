...
def main():
	...
	checkSuccess(cur.getField(0,13),btos("text1"))
	checkSuccess(cur.getField(0,14),"varchar1")
	checkSuccess(cur.getField(0,15),btos("tinytext1"))
	checkSuccess(cur.getField(0,16),btos("mediumtext1"))
	checkSuccess(cur.getField(0,17),btos("longtext1"))
	print()
	...
	checkSuccess(cur.getField(7,13),btos("text8"))
	checkSuccess(cur.getField(7,14),"varchar8")
	checkSuccess(cur.getField(7,15),btos("tinytext8"))
	checkSuccess(cur.getField(7,16),btos("mediumtext8"))
	checkSuccess(cur.getField(7,17),btos("longtext8"))
	print()
	...
	checkSuccess(cur.getField(0,"testtext"),btos("text1"))
	checkSuccess(cur.getField(0,"testvarchar"),"varchar1")
	checkSuccess(cur.getField(0,"testtinytext"),btos("tinytext1"))
	checkSuccess(cur.getField(0,"testmediumtext"),btos("mediumtext1"))
	checkSuccess(cur.getField(0,"testlongtext"),btos("longtext1"))
	print()
	...
	checkSuccess(cur.getField(7,"testtext"),btos("text8"))
	checkSuccess(cur.getField(7,"testvarchar"),"varchar8")
	checkSuccess(cur.getField(7,"testtinytext"),btos("tinytext8"))
	checkSuccess(cur.getField(7,"testmediumtext"),btos("mediumtext8"))
	checkSuccess(cur.getField(7,"testlongtext"),btos("longtext8"))
	print()
	...
	checkSuccess(fields[13],btos("text1"))
	checkSuccess(fields[14],"varchar1")
	checkSuccess(fields[15],btos("tinytext1"))
	checkSuccess(fields[16],btos("mediumtext1"))
	checkSuccess(fields[17],btos("longtext1"))
	print()
	...
	checkSuccess(fields["testtext"],btos("text1"))
	checkSuccess(fields["testvarchar"],"varchar1")
	checkSuccess(fields["testtinytext"],btos("tinytext1"))
	checkSuccess(fields["testmediumtext"],btos("mediumtext1"))
	checkSuccess(fields["testlongtext"],btos("longtext1"))
	print()
	...
	checkSuccess(fields["testtext"],btos("text8"))
	checkSuccess(fields["testvarchar"],"varchar8")
	checkSuccess(fields["testtinytext"],btos("tinytext8"))
	checkSuccess(fields["testmediumtext"],btos("mediumtext8"))
	checkSuccess(fields["testlongtext"],btos("longtext8"))
	print()
	...
	checkSuccess(rows[0][13],btos("text1"))
	checkSuccess(rows[0][14],"varchar1")
	checkSuccess(rows[0][15],btos("tinytext1"))
	checkSuccess(rows[0][16],btos("mediumtext1"))
	checkSuccess(rows[0][17],btos("longtext1"))
	print()
	...
	checkSuccess(rows[1][13],btos("text2"))
	checkSuccess(rows[1][14],"varchar2")
	checkSuccess(rows[1][15],btos("tinytext2"))
	checkSuccess(rows[1][16],btos("mediumtext2"))
	checkSuccess(rows[1][17],btos("longtext2"))
	print()
	...
	checkSuccess(rows[2][13],btos("text3"))
	checkSuccess(rows[2][14],"varchar3")
	checkSuccess(rows[2][15],btos("tinytext3"))
	checkSuccess(rows[2][16],btos("mediumtext3"))
	checkSuccess(rows[2][17],btos("longtext3"))
	print()
	...
	checkSuccess(rows[3][13],btos("text4"))
	checkSuccess(rows[3][14],"varchar4")
	checkSuccess(rows[3][15],btos("tinytext4"))
	checkSuccess(rows[3][16],btos("mediumtext4"))
	checkSuccess(rows[3][17],btos("longtext4"))
	print()
	...
	checkSuccess(rows[4][13],btos("text5"))
	checkSuccess(rows[4][14],"varchar5")
	checkSuccess(rows[4][15],btos("tinytext5"))
	checkSuccess(rows[4][16],btos("mediumtext5"))
	checkSuccess(rows[4][17],btos("longtext5"))
	print()
	...
	checkSuccess(rows[5][13],btos("text6"))
	checkSuccess(rows[5][14],"varchar6")
	checkSuccess(rows[5][15],btos("tinytext6"))
	checkSuccess(rows[5][16],btos("mediumtext6"))
	checkSuccess(rows[5][17],btos("longtext6"))
	print()

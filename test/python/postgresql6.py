...
def main():
	...
	checkSuccess(fields["testdate"],"01-01-2001")
	...
	checkSuccess(fields["testdate"],"01-01-2008")
	...
	checkSuccess(rows[0][6],"01-01-2001")
	...
	checkSuccess(rows[1][6],"01-01-2002")
	...
	checkSuccess(rows[2][6],"01-01-2003")
	...
	checkSuccess(rows[3][6],"01-01-2004")
	...
	checkSuccess(rows[4][6],"01-01-2005")
	...
	checkSuccess(rows[5][6],"01-01-2006")

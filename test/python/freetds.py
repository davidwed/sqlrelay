...
def main():
	...
	# usage...
	if len(sys.argv) < 5:
		print "usage: freetds.py host port socket user password"
		sys.exit(0)
	...
	checkSuccess(rows[0][9],"Jan 01 2001 01:00AM")
	checkSuccess(rows[0][10],"Jan 01 2001 01:00AM")
	...
	checkSuccess(rows[1][9],"Jan 01 2002 02:00AM")
	checkSuccess(rows[1][10],"Jan 01 2002 02:00AM")
	...
	checkSuccess(rows[2][9],"Jan 01 2003 03:00AM")
	checkSuccess(rows[2][10],"Jan 01 2003 03:00AM")
	...
	checkSuccess(rows[3][9],"Jan 01 2004 04:00AM")
	checkSuccess(rows[3][10],"Jan 01 2004 04:00AM")
	...
	checkSuccess(rows[4][9],"Jan 01 2005 05:00AM")
	checkSuccess(rows[4][10],"Jan 01 2005 05:00AM")
	...
	checkSuccess(rows[5][9],"Jan 01 2006 06:00AM")
	checkSuccess(rows[5][10],"Jan 01 2006 06:00AM")

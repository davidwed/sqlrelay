...
# instantiation
$con1=SQLRelay::Connection->new("sqlrserver",9000,"/tmp/test.socket",
							"test","test",0,1);
$cur1=SQLRelay::Cursor->new($con1);
$cur1->sendQuery("select 1 from dual");


$con2=SQLRelay::Connection->new("sqlrserver",9000,"/tmp/test.socket",
							"test","test",0,1);
...
$con3=SQLRelay::Connection->new("sqlrserver",9000,"/tmp/test.socket",
							"test","test",0,1);

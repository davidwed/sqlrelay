...
int	main(int argc, char **argv) {
	...
	checkSuccessInt(sqlrcur_getLongestByIndex(cur,7),6);
	checkSuccessInt(sqlrcur_getLongestByName(cur,"testmoney"),6);
	...
	checkSuccessInt(sqlrcur_getFieldLengthByIndex(cur,0,7),6);
	...
	checkSuccessInt(sqlrcur_getFieldLengthByIndex(cur,7,7),6);
	...
	checkSuccessInt(sqlrcur_getFieldLengthByName(cur,0,"testmoney"),6);
	...
	checkSuccessInt(sqlrcur_getFieldLengthByName(cur,7,"testmoney"),6);

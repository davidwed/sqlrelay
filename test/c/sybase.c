...
int	main(int argc, char **argv) {
	...
	// usage...
	if (argc<5) {
		printf("usage: sybase host port socket user password\n");
		exit(0);
	}
	...
	checkSuccessString(sqlrcur_getColumnTypeByIndex(cur,11),"LONGCHAR");
	checkSuccessString(sqlrcur_getColumnTypeByName(cur,"testchar"),"LONGCHAR");
	checkSuccessString(sqlrcur_getColumnTypeByIndex(cur,12),"LONGCHAR");
	checkSuccessString(sqlrcur_getColumnTypeByName(cur,"testvarchar"),"LONGCHAR");
	...
	checkSuccessInt(sqlrcur_getColumnLengthByIndex(cur,11),80);
	checkSuccessInt(sqlrcur_getColumnLengthByName(cur,"testchar"),80);
	checkSuccessInt(sqlrcur_getColumnLengthByIndex(cur,12),80);
	checkSuccessInt(sqlrcur_getColumnLengthByName(cur,"testvarchar"),80);

...
int	main(int argc, char **argv) {
	...
	checkSuccessInt(sqlrcur_sendQuery(cur,"create table testdb.testtable (testtinyint tinyint, testsmallint smallint, testmediumint mediumint, testint int, testbigint bigint, testfloat float, testreal real, testdecimal decimal(1,1), testdate date, testtime time, testdatetime datetime, testyear year, testchar char(40), testtext text, testvarchar varchar(40), testtinytext tinytext, testmediumtext mediumtext, testlongtext longtext, testtimestamp timestamp)"),1);
	printf("\n");
	...
	checkSuccessString(sqlrcur_getColumnTypeByIndex(cur,16),"BLOB");
	checkSuccessString(sqlrcur_getColumnTypeByIndex(cur,17),"BLOB");
	...
	checkSuccessString(sqlrcur_getColumnTypeByName(cur,"testmediumtext"),"BLOB");
	checkSuccessString(sqlrcur_getColumnTypeByName(cur,"testlongtext"),"BLOB");
	...
	checkSuccessInt(sqlrcur_getColumnLengthByIndex(cur,1),6);
	checkSuccessInt(sqlrcur_getColumnLengthByIndex(cur,2),9);
	checkSuccessInt(sqlrcur_getColumnLengthByIndex(cur,3),11);
	...
	checkSuccessInt(sqlrcur_getColumnLengthByIndex(cur,11),4);
	checkSuccessInt(sqlrcur_getColumnLengthByIndex(cur,12),40);
	checkSuccessInt(sqlrcur_getColumnLengthByIndex(cur,13),65535);
	checkSuccessInt(sqlrcur_getColumnLengthByIndex(cur,14),40);
	checkSuccessInt(sqlrcur_getColumnLengthByIndex(cur,15),255);
	checkSuccessInt(sqlrcur_getColumnLengthByIndex(cur,16),16777215);
	checkSuccessInt(sqlrcur_getColumnLengthByIndex(cur,17),16777215);
	checkSuccessInt(sqlrcur_getColumnLengthByIndex(cur,18),14);
	checkSuccessInt(sqlrcur_getColumnLengthByName(cur,"testtinyint"),4);
	checkSuccessInt(sqlrcur_getColumnLengthByName(cur,"testsmallint"),6);
	checkSuccessInt(sqlrcur_getColumnLengthByName(cur,"testmediumint"),9);
	checkSuccessInt(sqlrcur_getColumnLengthByName(cur,"testint"),11);
	...
	checkSuccessInt(sqlrcur_getColumnLengthByName(cur,"testyear"),4);
	...
	checkSuccessInt(sqlrcur_getColumnLengthByName(cur,"testlongtext"),16777215);
	checkSuccessInt(sqlrcur_getColumnLengthByName(cur,"testtimestamp"),14);
	printf("\n");

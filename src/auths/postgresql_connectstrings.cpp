...
class SQLRSERVER_DLLSPEC sqlrauth_postgresql_connectstrings : public sqlrauth {
	public:
			sqlrauth_postgresql_connectstrings(
...
const char *sqlrauth_postgresql_connectstrings::auth(sqlrcredentials *cred) {
...
bool sqlrauth_postgresql_connectstrings::compare(const char *suppliedresponse,
						uint64_t suppliedresponselength,
						const char *user,
						const char *validpassword,
						const char *method,

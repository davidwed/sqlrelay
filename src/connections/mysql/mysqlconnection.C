...
printf("input bind string failed\n");
		return false;
	}
...
bool mysqlcursor::inputBindDouble(const char *variable, 
	...
	// variables defined when the query was prepared
	if (bindcounter>bindcount) {
printf("input bind double failed\n");
		return false;
	}
...
bool mysqlcursor::outputBindString(const char *variable, 
	...
	// variables defined when the query was prepared
	if (bindcounter>bindcount) {
printf("output bind string failed\n");
		return false;
	}
...
bool mysqlcursor::outputBindDouble(const char *variable, 
	...
	// variables defined when the query was prepared
	if (bindcounter>bindcount) {
printf("output bind double failed\n");
		return false;
	}
...
bool mysqlcursor::outputBindBlob(const char *variable, 
	...
	// variables defined when the query was prepared
	if (bindcounter>bindcount) {
printf("output bind blob failed\n");
		return false;
	}
...
printf("clean up data\n");
	...
	delete[] columnnames;
	columnnames=NULL;
printf("done with clean up data\n");
}

...
class SQLRUTIL_DLLSPEC sqlrconfig_xmldom : public sqlrconfig, public xmlsax {
	public:
			sqlrconfig_xmldom();
			~sqlrconfig_xmldom();
...
sqlrconfig_xmldom::sqlrconfig_xmldom() : sqlrconfig(), xmlsax() {
	init();
}
...
bool sqlrconfig_xmldom::text(const char *string) {

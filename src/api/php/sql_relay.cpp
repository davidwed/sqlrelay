...
#include <config.h>
	...
	#define ZEND_FETCH_RESOURCE(a,b,c,d,e,f) if ((a=(b)zend_fetch_resource(Z_RES_P(c),e,f)) == NULL) { RETURN_FALSE; }
	#define ZVAL zval*
	...
	#define ADD_ASSOC_STRINGL(a,b,c,d,e) add_assoc_stringl(a,b,zend_string_init(c,d,0),d)
#else
	#define ZVAL zval**
